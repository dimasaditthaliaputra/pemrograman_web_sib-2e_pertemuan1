                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    $row['user_id']; ?>" onclick="javascript:return confirm('Hapus Data Jabatan ?');" class="btn btn-danger btn-xs">
                    ...
                    <div class="modal-content">
                        ...
                        <form action="fungsi/tambah.php?anggota=tambah" method="POST">
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    <label for="recipient-name" class="col-formlabel">Jabatan:</label>
                                    <select class="form-select" name="jabatan" name arialabel="Default select example">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check form-check-inline">
                                        ...
                                        <label class="form-check-label" for="inlineRadio1">LakiLaki</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="alamat" id="messagetext"></textarea>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label for="recipient-name" class="col-formlabel">Username:</label>
                                    <input type="text" name="username" class="form-control"
                                        id="recipient-name">
                                </div>
                                <div class="mb-3">
                                    <label for="recipient-name" class="col-formlabel">Password:</label>
                                    <input type="password" name="password" class="form-control"
                                        id="recipient-name">
                                </div>
                                <div class="mb-3">
                                    <label for="recipient-name" class="col-formlabel">Level:</label>
                                    <select class="form-select" name="level" name arialabel="Default select example">
