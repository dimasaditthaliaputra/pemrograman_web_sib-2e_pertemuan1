                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="index.php?page=jabatan/edit&id=<?php echo $row['id'];
                                                                            ?>" class="btn btn-warning btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a>
                                    <a href="fungsi/hapus.php?jabatan=hapus&id=<?php echo
                                                                                $row['id']; ?>" onclick="javascript:return confirm('Hapus Data Jabatan ?');" class="btn btn-danger
btn-xs"><i class="fa fa-trash-o" aria-hidden="true"></i> Hapus</a>
                                </td>
                            </tr>
                        <?php
                        }
                    ...
                    <div class="modal-content">
                        ...
                        <form action="fungsi/tambah.php?jabatan=tambah" method="POST">
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    <label for="message-text" class="col-formlabel">Keterangan:</label>
                                    <textarea class="form-control" name="keterangan" id="messagetext"></textarea>
                                </div>
                            </div>
